  ...
  <div class="row">
    ...
    <div class="col-12 col-lg-6 col-md-10 col-sm-10">
      <div class="container mt-5 mb-4c pb-2 rounded" style="background-color:#60b3D1;">
        ...
        <form class="form-family" action="create_student.php" method="POST">
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="roll_no" name="roll-no"/>
            <p class="error-message text-danger" id="rollno-error"></p>
          </div>

          <div class="form-group mb-3">
            <label class="form-lable">Gender</label>
            <input class="form-check-input ms-2" type="radio" id="gender_male" name="gender" value="male"/>
            <label class="form-lable" for="gender_male">Male</label>
            <input class="form-check-input ms-2" type="radio" id="gender_female" name="gender" value="female"/>
            <label class="form-lable" for="gender_female">Female</label>
            <input class="form-check-input ms-2" type="radio" id="gender_others" name="gender" value="others"/>
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" id="mobile-no" class="form-control" name="mobile-no" placeholder="1234567890" />
            <p class="error-message text-danger" id="mobile-error"></p>
          </div>

          <div class="form-group mb-3">
            <label class="form-lable" for="email">Email</label>
            <input type="text" class="form-control" id="email" name="email" placeholder="janu123@gmail.com" />
